...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'projects.dataclair.title': 'DataClair',
    'projects.dataclair.desc': 'Advanced data visualization and analytics platform built with modern web technologies.',
  ...
  fr: {
    ...
    'projects.dataclair.title': 'DataClair',
    'projects.dataclair.desc': 'Plateforme avancée de visualisation et d\'analyse de données construite avec des technologies web modernes.',
  ...
  es: {
    ...
    'projects.dataclair.title': 'DataClair',
    'projects.dataclair.desc': 'Plataforma avanzada de visualización y análisis de datos construida con tecnologías web modernas.',
